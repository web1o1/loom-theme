...
class AQ_Slider_Block extends AQ_Block {
	...
	?>
		...
		<div class="description cf">
			...
			<p></p>
			<a href="#" rel="slide" class="aq-sortable-add-new button"><?php _e('Add New', 'loom'); ?></a>
			<p></p>
		</div>
		...
		<li id="<?php echo $this->get_field_id('tabs') ?>-sortable-item-<?php echo $count ?>" class="sortable-item" rel="<?php echo $count ?>">
			...
			<div class="sortable-head cf">
				...
				<div class="sortable-handle">
					<a href="#"><?php _e('Open / Close', 'loom'); ?></a>
				</div>
			</div>
	...
	?>
		...
		<div class="owl-slider-wrapper main">
		  <div id="<?php echo $block_id; ?>" class="owl-portfolio-slider owl-carousel ebor-portfolio-slider">
		...
		<script type="text/javascript">
			jQuery(document).ready(function () {
				var <?php echo $block_id; ?> = jQuery("#<?php echo $block_id; ?>");
				
			    <?php echo $block_id; ?>.owlCarousel({
			        navigation: false,
			        autoHeight: true,
			        slideSpeed: 300,
			        paginationSpeed: 400,
			    ...
			    <?php echo $block_id; ?>.next().find(".slider-next").click(function () {
			        <?php echo $block_id; ?>.trigger('owl.next');
			    });
			    <?php echo $block_id; ?>.next().find(".slider-prev").click(function () {
			        <?php echo $block_id; ?>.trigger('owl.prev');
			    });
